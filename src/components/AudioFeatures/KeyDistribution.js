...
function KeyDistribution() {
    ...
    useEffect(() => {
        if (data.length > 0) {
            ...
            var svg = d3.select("#keyDistribution")
                .append("svg")
            ...
            var rollup = d3.rollup(data, D => D.length, d => d.key)
    ...
    return (
        <>
            <h5 className='spotifyGreen'>Distribution of Keys Used in Songs</h5>
